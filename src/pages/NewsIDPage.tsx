    ...
    return (
        <div className='row'>
            ...
            <div className='col s12'>
                ...
                <h6 className='col s12'><b>Author: </b>{article[0].author.replace(/(\<(\/?[^>]+)>)/g, '')}</h6>
                <h6 className='col s12'><b>Published time: </b>{article[0].publishedAt}</h6>
                <div className='col s12'>
                    <p className='flow-text col s12'>{article[0].description.replace(/(\<(\/?[^>]+)>)/g, '')}</p>
                    <p className='flow-text col s12'>{article[0].content.replace(/(\<(\/?[^>]+)>)/g, '')}</p>
                </div>
